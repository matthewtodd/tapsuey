...
Then create <tt>config/initializers/tapsuey.rb</tt>:
 ...
 # Where your production deployment lives:
 Tapsuey.host     = 'myapp.com'

 # Will need to be the *same* for development and production.
 # ENV isn't necessary, of course. Rails.root.join('config', 'tapsuey.txt').read.strip will also do.
